...
const Menu = () => {
  return(
    <div id="menu-bar" class="menu-bar">
      <span><a href="#"><img src="https://getheavy.com/wp-content/uploads/2019/12/spotify2019-830x350.jpg" alt="Spotify Logo" /></a></span>
      <nav class="navbar">
        <ul>
          <li><a class="active" href="#"><svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M448 463.746h-149.333v-149.333h-85.334v149.333h-149.333v-315.428l192-111.746 192 110.984v316.19z" fill="currentColor"></path></svg>Home</a></li>
          <li><a href="#"><svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M349.714 347.937l93.714 109.969-16.254 13.969-93.969-109.969q-48.508 36.825-109.207 36.825-36.826 0-70.476-14.349t-57.905-38.603-38.603-57.905-14.349-70.476 14.349-70.476 38.603-57.905 57.905-38.603 70.476-14.349 70.476 14.349 57.905 38.603 38.603 57.905 14.349 70.476q0 37.841-14.73 71.619t-40.889 58.921zM224 377.397q43.428 0 80.254-21.461t58.286-58.286 21.461-80.254-21.461-80.254-58.286-58.285-80.254-21.46-80.254 21.46-58.285 58.285-21.46 80.254 21.46 80.254 58.285 58.286 80.254 21.461z" fill="currentColor" fill-rule="evenodd"></path></svg>Search</a></li>
          <li><a href="#"><svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M291.301 81.778l166.349 373.587-19.301 8.635-166.349-373.587zM64 463.746v-384h21.334v384h-21.334zM192 463.746v-384h21.334v384h-21.334z" fill="currentColor"></path></svg>Your Library</a></li>
        </ul>
      </nav>
      
      <nav class="user-collection">
        <ul>
          <li><a href="#"><i class="fa fa-plus-square fa-lg" aria-hidden="true"></i>Create Playlist</a></li>
          <li><a href="#"><i class="fa fa-heart fa-lg" aria-hidden="true"></i>Liked Songs</a></li>
          <li><a href="#"><i class="fa fa-podcast fa-lg" aria-hidden="true"></i>Your Episodes</a></li>
        </ul>
      </nav>
      
      <span class="install-app"><a href="#"><i class="fa fa-arrow-circle-down fa-lg" aria-hidden="true"></i>Install App</a></span>
    </div>
  )
}
      ...
      <div>
        ...
        <div class="dropdown">
          <button onClick={handleClick}>
            ...
            Rajesh
            <i className={`fa fa-caret-${profileVisibility == 'hidden'? 'down' : 'up'}`} aria-hidden="true"></i>
          </button>
          <ul style={{visibility: `${profileVisibility}`}}>
            <li><a href="#" target="_blank">Account<i class="fa fa-external-link" aria-hidden="true"></i></a>
            </li>
